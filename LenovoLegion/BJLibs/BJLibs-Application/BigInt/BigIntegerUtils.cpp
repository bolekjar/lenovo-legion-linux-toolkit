...
std::ostream &operator <<(std::ostream &os, const BigUnsigned &x) {
	...
	if (osFlags & os.dec)
        ...
        THROW_EXCEPTION(BigIntegerUtilsException::exception_T,BigIntegerUtilsException::ERROR_CODES::GENERIC_ERROR,"std::ostream << BigUnsigned: Could not determine the desired base from output-stream flags")
