...
public:
    ...
    uint32_t       toUnsignedInt32() const;
    int32_t        toInt32        () const;
    uint16_t       toUnsignedInt16() const;
...
inline BigUnsigned BigUnsigned::operator /(const BigUnsigned &x) const {
    if (x.isZero())
        THROW_EXCEPTION(exception_T,ERROR_CODES::GENERIC_ERROR,"BigUnsigned::operator /: division by zero")
	BigUnsigned q, r;
	r = *this;
...
void BigUnsigned::initFromSignedPrimitive(X x) {
	if (x < 0)
        THROW_EXCEPTION(exception_T,ERROR_CODES::GENERIC_ERROR,"BigUnsigned constructor: "
...
X BigUnsigned::convertToPrimitive() const {
    ...
    THROW_EXCEPTION(exception_T,ERROR_CODES::GENERIC_ERROR,"BigUnsigned::to<Primitive>: "
