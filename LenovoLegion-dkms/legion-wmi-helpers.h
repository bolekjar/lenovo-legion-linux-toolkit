...
#define LEGION_WMI_ATTR_RO(_name,_func)		          \
{                                                         \
	.attr = { .name = __stringify(_name), .mode = 0444 }, \
	.show = func_##_func##_show,                          \
}

#define LEGION_WMI_ATTR_WO(_name,_func)		           \
{                                                          \
	.attr  = { .name = __stringify(_name), .mode = 0220 }, \
	.store = func_##_func##_store,                         \
}

#define LEGION_WMI_ATTR_RW(_name,_func) \
	__ATTR(_name, 0644, func_##_func##_get, func_##_func##_set)


#define LEGION_WMI_KOBJ_ATTR_RO_STATIC_STRING(_name,_attr,_func) \
